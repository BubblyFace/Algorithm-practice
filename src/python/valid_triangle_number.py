    ...
    def triangleNumber(self, nums) -> int:
        ...
        if l_n < 3:
            ...
            while index < l_n - 3:
                ...
                if self.s_nums[index] == 0:
                    index = index + 1
                    seed1 = index + 1
                    seed2 = seed1 + 1
                    continue
                elif self.s_nums[index] == 1 and self.s_nums[seed1] == 1:
                    index = index + 1
                    seed1 = index + 1
                    seed2 = seed1 + 1
                    continue
                ...
                if seed2 < l_n - 1:
                    ...
                    add_n = n_match - n_match_org
                    while self.s_nums[index] == self.s_nums[index + 1] and index < l_n - 3 :
                        n_match = n_match + add_n
                        index = index + 1
                    index = index
                    seed1 = index + 1
                    seed2 = seed1 + 1
